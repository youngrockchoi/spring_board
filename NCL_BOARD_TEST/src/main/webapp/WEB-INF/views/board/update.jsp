				...
				<form action="/udtBoard" method="post">
					<table class="b_3">
						...
						<thead>
							...
							<tr>
								<th>작성자</th>
								<td id="noticEmpName"><input type="text" class="post_writer-input" name="writer" placeholder="${boardDetailVO.getWriter() }"></td>
								<th>작성일</th>
							...
							<tr>
								...
								<td id="contrnTd" colspan="3" height="400" valign="top">
									<div class="contents6" id="noticeContents">
										<textarea name="content" placeholder="${boardDetailVO.getContent()}" rows="30"
											cols="160"></textarea>
									</div>
								</td>
							</tr>
